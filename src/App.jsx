    ...
    <>
      <div className='bg-gradient-to-t from-yellow-100 to-white'>
        <div className='flex sm:flex-row flex-col'>
          <div>
            <img src='./assets/1.png' alt='image-trophy' className='w-full' />
          </div>
          <div className='flex flex-col'>
            ...
            <img className='my-4 px-4' src='./assets/2.png' />
        ...
        <div className='px-6'>
          ...
          <div className='flex flex-col justify-center items-center'>
            <img src='./assets/3.png' alt='machines' className='py-4 md:px-28' />
